...
class CalculoParticipacaoTest {
    ...
    void calculaParticipacaoLucro(){
        ...
        assertEquals(38323.24,  participacao.calculaParticipacao((salarioMinimo * 8) + 0.01, Peso.PESO_1  /** TEMPO **/, Peso.PESO_1/** AREA **/, Peso.PESO_5 /** SALARIO **/));
        ...
        assertEquals(95808.47,  participacao.calculaParticipacao((salarioMinimo * 2) + 0.01, Peso.PESO_1  /** TEMPO **/, Peso.PESO_3/** AREA **/, Peso.PESO_1 /** SALARIO **/));
        ...
        assertEquals(76646.49,  participacao.calculaParticipacao((salarioMinimo * 8) + 0.01, Peso.PESO_1  /** TEMPO **/, Peso.PESO_3/** AREA **/, Peso.PESO_5 /** SALARIO **/));
        ...
        assertEquals(95808.47,  participacao.calculaParticipacao((salarioMinimo * 2) + 0.01, Peso.PESO_2  /** TEMPO **/, Peso.PESO_2/** AREA **/, Peso.PESO_1 /** SALARIO **/));
        ...
        assertEquals(76646.49,  participacao.calculaParticipacao((salarioMinimo * 8) + 0.01, Peso.PESO_2  /** TEMPO **/, Peso.PESO_2/** AREA **/, Peso.PESO_5 /** SALARIO **/));

        assertEquals(119760.59, participacao.calculaParticipacao((salarioMinimo * 2) + 0.01, Peso.PESO_2  /** TEMPO **/, Peso.PESO_3/** AREA **/, Peso.PESO_1 /** SALARIO **/));
        ...
        assertEquals(95808.11,  participacao.calculaParticipacao((salarioMinimo * 8) + 0.01, Peso.PESO_2  /** TEMPO **/, Peso.PESO_3/** AREA **/, Peso.PESO_5 /** SALARIO **/));

        assertEquals(167664.83, participacao.calculaParticipacao((salarioMinimo * 2) + 0.01, Peso.PESO_2  /** TEMPO **/, Peso.PESO_5/** AREA **/, Peso.PESO_1 /** SALARIO **/));
        assertEquals(125748.41, participacao.calculaParticipacao((salarioMinimo * 3) + 0.01, Peso.PESO_2  /** TEMPO **/, Peso.PESO_5/** AREA **/, Peso.PESO_2 /** SALARIO **/));
        ...
        assertEquals(134131.36, participacao.calculaParticipacao((salarioMinimo * 8) + 0.01, Peso.PESO_2  /** TEMPO **/, Peso.PESO_5/** AREA **/, Peso.PESO_5 /** SALARIO **/));
        ...
        assertEquals(76646.49,  participacao.calculaParticipacao((salarioMinimo * 8)+0.01,  Peso.PESO_3   /** TEMPO **/, Peso.PESO_1/** AREA **/, Peso.PESO_5 /** SALARIO **/));

        assertEquals(119760.59, participacao.calculaParticipacao((salarioMinimo * 2) + 0.01, Peso.PESO_3  /** TEMPO **/, Peso.PESO_2/** AREA **/, Peso.PESO_1 /** SALARIO **/));
        ...
        assertEquals(95808.11,  participacao.calculaParticipacao((salarioMinimo * 8) + 0.01, Peso.PESO_3  /** TEMPO **/, Peso.PESO_2/** AREA **/, Peso.PESO_5 /** SALARIO **/));
        ...
        assertEquals(191616.95, participacao.calculaParticipacao((salarioMinimo * 2) + 0.01, Peso.PESO_3  /** TEMPO **/, Peso.PESO_5/** AREA **/, Peso.PESO_1 /** SALARIO **/));
        ...
        assertEquals(167664.83, participacao.calculaParticipacao((salarioMinimo * 2) + 0.01, Peso.PESO_5  /** TEMPO **/, Peso.PESO_2/** AREA **/, Peso.PESO_1 /** SALARIO **/));
        assertEquals(125748.41, participacao.calculaParticipacao((salarioMinimo * 3) + 0.01, Peso.PESO_5  /** TEMPO **/, Peso.PESO_2/** AREA **/, Peso.PESO_2 /** SALARIO **/));
        ...
        assertEquals(134131.36, participacao.calculaParticipacao((salarioMinimo * 8) + 0.01, Peso.PESO_5  /** TEMPO **/, Peso.PESO_2/** AREA **/, Peso.PESO_5 /** SALARIO **/));

        assertEquals(191616.95, participacao.calculaParticipacao((salarioMinimo * 2) + 0.01, Peso.PESO_5  /** TEMPO **/, Peso.PESO_3/** AREA **/, Peso.PESO_1 /** SALARIO **/));
        ...
        assertEquals(239521.19, participacao.calculaParticipacao((salarioMinimo * 2) + 0.01, Peso.PESO_5  /** TEMPO **/, Peso.PESO_5/** AREA **/, Peso.PESO_1 /** SALARIO **/));
        ...
        assertEquals(191616.23, participacao.calculaParticipacao((salarioMinimo * 8) + 0.01, Peso.PESO_5  /** TEMPO **/, Peso.PESO_5/** AREA **/, Peso.PESO_5 /** SALARIO **/));
